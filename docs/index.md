...
* `nodejs-dev-hoge-app` – アプリケーションのサンプルコードと Dockerfile を格納  
* `nodejs-dev-hoge-manifest` – K8s マニフェストと CI/CD 関連ファイルを格納  
...
```bash
git clone https://github.com/rhdh-skitamura-org/nodejs-dev-hoge-app.git
cd nodejs-dev-hoge-app
